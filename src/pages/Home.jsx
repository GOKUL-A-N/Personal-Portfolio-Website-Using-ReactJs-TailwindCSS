  ...
  return (
    <main className={`${styles.main} flex items-center justify-center h-screen w-full`}>
      ...
      >
        ...
        <h1 onMouseEnter={() => {setIsHovered(true)}} onMouseLeave={() => {setIsHovered(false)}} className='text-center text-[40px] sm:text-[45px] leading-tight md:text-[75px] xl:text-[85px]   uppercase font-black'><span>Robbing</span> <br /> <span>Good</span> <br /> <span>Designs</span> <br /> <span>Since</span> <br /> <span>2021</span> </h1>
        </div> 
      </motion.div>
